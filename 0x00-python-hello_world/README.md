...
This project introduces **Python**: running scripts, the shebang line, printing text and variables, and indexing/slicing strings. You write simple scripts and run them with the Python interpreter.
...
1. Create each file with the correct shebang where needed and make scripts executable (`chmod +x`).
2. Run with `python3 <file>.py` or `./script` as indicated.
3. Check style with `pycodestyle *.py`.
